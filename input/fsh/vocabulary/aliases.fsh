...
Alias: $nz-residency-status-vs = https://standards.digital.health.nz/fhir/ValueSet/nz-residency-status-code

Alias: $citizenship-status-vs = https://standards.digital.health.nz/fhir/ValueSet/nz-citizenship-status-code
//Alias: $ethnic-group-4 = http:/hl7.org.nz/fhir/ValueSet/ethnic-group-level-4-code

Alias: $practitioner-reg-status = https://standards.digital.health.nz/fhir/ValueSet/practitioner-registration-status-code
Alias: $practitioner-scope-practice = https://standards.digital.health.nz/fhir/ValueSet/practitioner-scope-of-practice-code


Alias: $domicile-code-vs = https://standards.digital.health.nz/fhir/ValueSet/domicile-code
Alias: $funded-programme-vs = https://standards.digital.health.nz/fhir/ValueSet/funded-programme-code
